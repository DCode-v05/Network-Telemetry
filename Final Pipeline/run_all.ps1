...
#   5. export raw streams -> dashboard/public/data/streams.json (LIVE in-browser detector)
...
Write-Host "`n==> [5/6] export raw streams for the LIVE dashboard" -ForegroundColor Cyan
python (Join-Path $root 'python\export_streams.py')

Write-Host "`n==> [6/6] sync dashboard data" -ForegroundColor Cyan
